...
| VECTOR_DB_PROVIDER       | Default vector DB provider used when a site has no per-site config. One of `qdrant\|opensearch\|elasticsearch\|pinecone\|weaviate\|milvus\|chroma\|pgvector\|redis\|mongo-atlas`. Default: `qdrant`        |
| VECTOR_DB_ENCRYPTION_KEY | AES-256-GCM key for encrypting vector DB credentials saved via the admin UI. Must be set in production and identical for webapp and ai-service (common.env is shared). e.g. `openssl rand -base64 48`      |
| OPENSEARCH_ENDPOINT      | OpenSearch endpoint URL (used when VECTOR_DB_PROVIDER=opensearch)                                                                                                                                          |
| OPENSEARCH_USERNAME      | OpenSearch username                                                                                                                                                                                        |
| OPENSEARCH_PASSWORD      | OpenSearch password                                                                                                                                                                                        |
| ELASTICSEARCH_NODE       | Elasticsearch node URL (used when VECTOR_DB_PROVIDER=elasticsearch)                                                                                                                                        |
| ELASTICSEARCH_API_KEY    | Elasticsearch API key (alternative to username/password)                                                                                                                                                   |
| ELASTICSEARCH_USERNAME   | Elasticsearch username                                                                                                                                                                                     |
| ELASTICSEARCH_PASSWORD   | Elasticsearch password                                                                                                                                                                                     |
| PINECONE_API_KEY         | Pinecone API key (used when VECTOR_DB_PROVIDER=pinecone)                                                                                                                                                   |
| PINECONE_HOST            | Pinecone index host URL (e.g. https://your-index-xxxx.svc.region.pinecone.io)                                                                                                                              |
| WEAVIATE_URL             | Weaviate URL (used when VECTOR_DB_PROVIDER=weaviate)                                                                                                                                                       |
| WEAVIATE_API_KEY         | Weaviate API key                                                                                                                                                                                          |
| MILVUS_HOST              | Milvus host (used when VECTOR_DB_PROVIDER=milvus)                                                                                                                                                          |
| MILVUS_PORT              | Milvus port (default 19530)                                                                                                                                                                                |
| MILVUS_USERNAME          | Milvus username (optional)                                                                                                                                                                                 |
| MILVUS_PASSWORD          | Milvus password (optional)                                                                                                                                                                                 |
| MILVUS_DB_NAME           | Milvus database name (default `default`)                                                                                                                                                                   |
| CHROMA_URL               | Chroma URL (used when VECTOR_DB_PROVIDER=chroma)                                                                                                                                                           |
| CHROMA_API_KEY           | Chroma API key (optional)                                                                                                                                                                                  |
| CHROMA_DATABASE          | Chroma database name (optional, default `default_database`)                                                                                                                                                |
| PGVECTOR_URL             | PostgreSQL/pgvector connection string (used when VECTOR_DB_PROVIDER=pgvector)                                                                                                                              |
| REDIS_VECTOR_URL         | Redis Stack (RediSearch) URL for vectors (used when VECTOR_DB_PROVIDER=redis)                                                                                                                              |
| REDIS_VECTOR_PASSWORD    | Redis password (optional; alternatively embed in REDIS_VECTOR_URL)                                                                                                                                         |
| MONGO_ATLAS_VECTOR_URL   | MongoDB Atlas connection string (used when VECTOR_DB_PROVIDER=mongo-atlas)                                                                                                                                 |
| MONGO_ATLAS_VECTOR_DB    | MongoDB Atlas database name                                                                                                                                                                                |
| MONGO_ATLAS_VECTOR_INDEX | MongoDB Atlas vector search index name                                                                                                                                                                     |
...
| private.sso.ldap.url                    | LDAP server URL ("ldap://host" or "ldaps://host")                                                                                                                                                                                                                                                                       |
| private.sso.ldap.port                   | LDAP port (default 389, 636 for ldaps)                                                                                                                                                                                                                                                                                  |
| private.sso.ldap.dn                     | direct-bind DN template; "#{username}" is replaced (e.g., "uid=#{username},ou=people,dc=example,dc=com"). Use this OR searchDN.                                                                                                                                                                                         |
| private.sso.ldap.searchDN               | service-account DN for search-then-bind (alternative to dn)                                                                                                                                                                                                                                                             |
| private.sso.ldap.searchCredentials      | service-account password for searchDN                                                                                                                                                                                                                                                                                   |
| private.sso.ldap.base                   | search base DN (e.g., "dc=example,dc=com")                                                                                                                                                                                                                                                                              |
...
- **Editor** (if mainPrefix configured): https://editor.sclab-onprem
